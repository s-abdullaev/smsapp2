...
{
    public class MapControlViewModel : BindableBase/* : ViewModelBase*/
    {
        ...
        //}
        private string mapPackagePath = @"Map\Map.mmpk";
        ...
        {
            mapPackage = await MobileMapPackage.OpenAsync(mapPackagePath);
